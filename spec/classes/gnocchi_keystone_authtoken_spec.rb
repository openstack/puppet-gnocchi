...
describe 'gnocchi::keystone::authtoken' do
  ...
  shared_examples 'gnocchi::keystone::authtoken' do

    context 'with default parameters' do

      it 'configure keystone_authtoken' do
        is_expected.to contain_keystone__resource__authtoken('gnocchi_config').with(
          :username                       => 'gnocchi',
          :password                       => 'gnocchi_password',
  ...
  on_supported_os({
    ...
    context "on #{os}" do
      ...
      it_configures 'gnocchi::keystone::authtoken'
    end
  end
