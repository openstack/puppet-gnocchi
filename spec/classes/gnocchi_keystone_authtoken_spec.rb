  ...
  shared_examples 'gnocchi authtoken' do
    ...
    context 'with default parameters' do
      ...
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_gnocchi_config('keystone_authtoken/auth_url').with_value('http://localhost:5000')
        is_expected.to contain_gnocchi_config('keystone_authtoken/project_name').with_value('services')
        is_expected.to contain_gnocchi_config('keystone_authtoken/user_domain_name').with_value('Default')
        is_expected.to contain_gnocchi_config('keystone_authtoken/project_domain_name').with_value('Default')
        ...
        is_expected.to contain_gnocchi_config('keystone_authtoken/www_authenticate_uri').with_value('http://localhost:5000')
        ...
        is_expected.to contain_gnocchi_config('keystone_authtoken/service_token_roles').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_gnocchi_config('keystone_authtoken/service_token_roles_required').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_gnocchi_config('keystone_authtoken/service_type').with_value('<SERVICE DEFAULT>')
        is_expected.to contain_gnocchi_config('keystone_authtoken/interface').with_value('<SERVICE DEFAULT>')
      end
    end
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_gnocchi_config('keystone_authtoken/www_authenticate_uri').with_value('https://10.0.0.1:9999/')
        ...
        is_expected.to contain_gnocchi_config('keystone_authtoken/service_token_roles').with_value(params[:service_token_roles])
        is_expected.to contain_gnocchi_config('keystone_authtoken/service_token_roles_required').with_value(params[:service_token_roles_required])
        is_expected.to contain_gnocchi_config('keystone_authtoken/service_type').with_value(params[:service_type])
        is_expected.to contain_gnocchi_config('keystone_authtoken/interface').with_value(params[:interface])
      end
